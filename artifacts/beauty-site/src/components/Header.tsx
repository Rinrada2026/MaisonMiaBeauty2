      ...
      <header className="sticky top-0 z-50 bg-white border-b border-border h-20 flex items-center px-4 justify-between" data-testid="header">
        ...
        <div className="flex-1 flex justify-center">
          <Link href="/" data-testid="header-logo-link">
            <img src={logoSrc} alt="Maison Mia" className="h-20 object-contain" style={{ filter: "brightness(0) saturate(100%) invert(63%) sepia(19%) saturate(560%) hue-rotate(302deg) brightness(92%) contrast(88%)" }} />
          </Link>
        </div>
